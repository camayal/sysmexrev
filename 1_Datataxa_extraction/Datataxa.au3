...
Local $aE[5] ;<== Define number of element to obtain from the FlatFile and below define which element ("//parentnode/childnode/childnode/...")
$aE[0] = "//GBSet/GBSeq/GBSeq_organism"
$aE[1] = "//GBSet/GBSeq/GBSeq_locus"
;$aE[2] = "//GBSet/GBSeq/GBSeq_length"
$aE[2] = "//GBSet/GBSeq/GBSeq_references/GBReference/GBReference_title"
$aE[3] = "//GBSet/GBSeq/GBSeq_references/GBReference/GBReference_journal"
$aE[4] = "//GBSet/GBSeq/GBSeq_create-date"

;Create file and define headings
Local $aT[6] ; <== Define number of titles for each column (Final must be extras)
